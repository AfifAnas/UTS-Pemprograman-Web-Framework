        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="blog-single.html">Pekerjaan dibidang Machine Learning mulai meningkat</a>
                    </h2>

                    <div class="entry-meta">
                        <ul>
                            <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">Admin</a></li>
                            <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="2021-01-01">Jan 1, 2021</time></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="blog-single.html">Kebutuhan Industri akan Desain Grafis mulai dilirik </a>
                    </h2>
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="blog-single.html">Praktek Industri PTIK dilaksanakan secara hybrid</a>
                    </h2>
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="blog-single.html">Konsultasi untuk mengambil Seminar Proposal mulai dilaksanakan minggu depan</a>
                    </h2>
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <div class="entry-img">
                        <img src="<?= base_url() ?>/assets/img/blog-5.jpg" alt="" class="img-fluid">
                    </div>

                    <h2 class="entry-title">
                        <a href="blog-single.html">Mahasiswa PTIK sebagian besar melakukan komunikasi secara daring.</a>
                    </h2>
            ...
            <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <article class="entry">
                    ...
                    <div class="entry-img">
                        <img src="<?= base_url() ?>/assets/img/blog-6.jpg" alt="" class="img-fluid">
                    </div>

                    <h2 class="entry-title">
                        <a href="blog-single.html">Harga Perangkat Komputer akan stabil pada tahun 2022</a>
                    </h2>
